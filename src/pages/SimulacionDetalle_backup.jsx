    ...
    <div className="simulacion-detalle-container">
      ...
      <main className="simulacion-main">
        <div className="simulacion-content">
          ...
          </div>components/molecules/CreditCounter'
...
function SimulacionDetalle() {
  ...
  const actualizarCreditos = () => {
    // Esta función se ejecutará en el próximo render automáticamente
    // ya que los créditos se calculan dinámicamente
  }
