...
function Login() {
    return (
        <div className="login">
            ...
            mx-auto relative sm:absolute top-0 sm:right-0">
                <img src={logo} width="200" className="m-[30px] sm:m-[60px]" alt="Logo UNAL" title="Logo UNAL" />
                ...
                <div className="sign-in mt-[40px] mb-[20px] sm:scale-[1.2] shadow-md shadow-black/20 rounded-[3px]"></div>
